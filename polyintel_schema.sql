...
\restrict 2L2KvnX8F38NQ3wggUJIGhHhUpjPpG1lHwwIgpvrcU2a0eZUxHaaD1ZcZgK7ryy
...
COMMENT ON COLUMN public.paper_trades.status IS 'OPEN | PARTIAL | CLOSED | STOPPED | TAKE_PROFIT | SMART_EXIT | EXPIRED';
...
--
-- Name: paper_trade_settings paper_trade_settings_user_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: sikapiapsby
--

ALTER TABLE ONLY public.paper_trade_settings
    ADD CONSTRAINT paper_trade_settings_user_id_foreign FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;
...
--
-- Name: trading_accounts trading_accounts_paper_trade_setting_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: sikapiapsby
--

ALTER TABLE ONLY public.trading_accounts
    ADD CONSTRAINT trading_accounts_paper_trade_setting_id_foreign FOREIGN KEY (paper_trade_setting_id) REFERENCES public.paper_trade_settings(id) ON DELETE SET NULL;
...
\unrestrict 2L2KvnX8F38NQ3wggUJIGhHhUpjPpG1lHwwIgpvrcU2a0eZUxHaaD1ZcZgK7ryy
